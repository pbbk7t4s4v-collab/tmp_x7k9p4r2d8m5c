...
class MergedLayoutScene2(Scene):
    def __init__(self, class_title_text="Regression", course_title="Machine Learning", 
                 avatar_image="csh.png", professor_name="Prof. Siheng Chen", 
                 background_image="SAI.png", **kwargs):
    ...
    def construct(self):
        ...
        # 3. 创建左侧内容
        course_title = Text(self.course_title, font_size=50, weight=BOLD)  # 使用传入的课程标题
