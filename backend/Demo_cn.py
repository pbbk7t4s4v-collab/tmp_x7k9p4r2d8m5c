...
class MergedLayoutScene2_cn(Scene):
    def __init__(self, class_title_text="分类", avatar_image="/home/TeachMasterAppV3/backend/TeachingMaster.png", 
    ...
    def construct(self):
        ...
        # 3. 创建左侧内容 (保持不变)
        class_title = Text(self.class_title_text, font="AR PL UKai CN", font_size=50, slant=ITALIC)
        ...
        main_content.arrange(RIGHT, buff=2.0, aligned_edge=UP)
